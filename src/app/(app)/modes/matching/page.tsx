...
import { MatchingSession } from '@/components/matching-session'
...
export default async function MatchingModePage() {
  ...
  const { data: progressVocab } = await supabase
    ...
    .limit(12) as { data: ProgressWithVocab[] | null } // Get 12 words for 6 pairs per round
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">
                You need at least 4 words in progress to use Matching mode.
              </p>
            </div>
  ...
  return <MatchingSession practiceWords={progressVocab} userId={user!.id} />
}
